...
<%
// Collect unique non-self-referential schema imports. Only `belongs_to`
// targets are referenced in this file (the FK `.references()` callback);
// has_many / has_one targets have no emission here.
