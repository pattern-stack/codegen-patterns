/**
 * JunctionIntegrationRepository integration-surface unit tests (#374).
 *
...
const roleConfig: JunctionIntegrationConfig = {
...
// ============================================================================
// Sequencing mock (mirrors the integrated-entity spec)
// ============================================================================
...
// ============================================================================
// integrationUpsertOne — strict dual-FK resolution
// ============================================================================

describe('JunctionIntegrationRepository.integrationUpsertOne', () => {
...
describe('JunctionIntegrationRepository.findByExternalIdProjected', () => {
...
describe('JunctionIntegrationRepository.softDeleteByExternalId', () => {
