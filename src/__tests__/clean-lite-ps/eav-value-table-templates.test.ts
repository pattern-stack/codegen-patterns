...
describe('clean-lite-ps eav_value_table — prompt-extension locals', () => {
  it('exposes eavValueTable + definition entity metadata', () => {
    const locals = buildCleanLitePsLocals(valueEntity, withEntities());
  ...
  it('zeros the metadata when the flag is absent', () => {
    const locals = buildCleanLitePsLocals(entityWithoutFlag, withEntities());
...
describe('clean-lite-ps eav_value_table — @generated banner', () => {
  ...
  it('stamps the banner as the first line of the repository when the local is supplied', () => {
    const locals = { ...buildCleanLitePsLocals(valueEntity, withEntities()), generatedBanner: banner };
...
describe('clean-lite-ps eav_value_table — composition with eav on owning entities', () => {
  it('handles a graph where one entity is eav_value_table + another is eav-enabled', () => {
    ...
    const valueLocals = buildCleanLitePsLocals(valueEntity, withEntities());
    ...
    const opportunityLocals = buildCleanLitePsLocals(opportunityEntity, withEntities());
