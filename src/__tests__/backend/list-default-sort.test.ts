/**
 * Template rendering tests for the backend list/search default sort
 * (#604 / GATE-2).
 *
...
function render(relPath: string, definition: unknown): string {
  ...
  const locals = buildBackendLocals(definition, withEntities());
...
describe('backend list use-case — default sort', () => {
