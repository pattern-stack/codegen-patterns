/**
 * Template rendering tests for backend Drizzle column/table feature
 ...
 * EJS body with locals from buildBackendLocals).
 */
...
function render(
  ...
  const locals = buildBackendLocals(definition, withEntities(baseLocals)) as Record<
    string,
    unknown
  >;
