...
describe('backend find-by-id use case — throws NotFoundException (D2)', () => {
...
describe('backend controller — ParseUUIDPipe on @Param (D3)', () => {
...
describe('backend controller — ZodValidationPipe on @Body (D4/D5)', () => {
...
describe('backend DTOs — schemas are exported as runtime values (D4/D5)', () => {
