...
**Status:** Implemented (Phase 1 + Phase 2) — port-promotion gate pending a broker (see §Verification)
**Date:** 2026-05-25
...
- Cron / `upsertJobScheduler` — **out of scope** (ADR-025 scheduling territory). Not implemented; BullMQ's repeatable-job / scheduler API is deliberately not surfaced in this PR.
