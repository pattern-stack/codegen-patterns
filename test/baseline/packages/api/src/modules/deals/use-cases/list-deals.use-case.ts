...
export class ListDealsUseCase {
   ...
   */
  async execute<TWith extends DealInclude = DealNoInclude>(
    query?: ListQuery,
    include?: TWith,
  ): Promise<Page<DealResult<TWith>>> {
    ...
    // (REL-2 §2.4). A pre-rendered fragment would name `deals`,
    ...
    const known =
      (deals as unknown as Record<string, unknown>)[sortColumn] !== undefined;
