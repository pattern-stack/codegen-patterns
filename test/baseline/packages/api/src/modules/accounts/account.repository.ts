...
/**
 * The relation keys a account read may include — the `with` surface of
 * `accounts` in this project's graph.
 *
...
/** The row shape a given account include tree resolves to, nested exactly as asked. */
export type AccountResult<TWith extends AccountInclude> =
  ResultOf<'accounts', TWith>;
 ...
 * OPTIONAL, the row's own columns required. `AccountResult<AccountInclude>`
 ...
 */
export type AccountApiResult = Account &
  Partial<AccountResult<AccountInclude>>;
