...
import type { PersonApiResult } from './person.repository';
...
export class PersonController {
  ...
  ): Promise<Page<PersonApiResult>> {
    // person has no relations in the generated graph, so there is no
