// @generated by @pattern-stack/codegen (subsystem jobs generator) — DO NOT EDIT. Hand edits are overwritten on re-emit. Regenerate with `bun run codegen`. To extend, use the codegen.config.yaml jobs block, then re-run `codegen subsystem install`.
/**
