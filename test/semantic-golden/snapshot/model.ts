...
const analytics: AggRegistry = {
	...
	opportunity: {
		...
		fields: {
			account_id: { type: 'uuid', column: 'account_id' },
			amount: { type: 'number', role: 'measure', aggs: ['sum', 'avg', 'min', 'max'], additivity: 'additive', column: 'amount' },
			...
			win_probability: { type: 'number', role: 'measure', agg: 'avg', additivity: 'non', column: 'win_probability' },
